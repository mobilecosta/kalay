	...
	#define STR0046 "Por Motorista+Prefijo+Titulo+Cuota"
	#define STR0047 "Por Motorista+Cliente+Tienda+Prefijo+Titulo+Cuota"
	#define STR0048 "Comisiones(Analitico)"
	#define STR0049 "Comisiones(Sintetico)"
	#define STR0050 "Vendedores"
	#define STR0051 "Comisiones s/ Liquidacion"
	#define STR0052 "Total general"
	#define STR0053 "Titulo"
	#define STR0054 "Porc."
	#define STR0055 "Comision"
#else
	#ifdef ENGLISH
		...
		#define STR0050 "Sales Representatives"
		#define STR0051 "Commissions w/o Settlement"
		#define STR0052 "Grand Total"
		#define STR0053 "Bill"
		#define STR0054 "Perc."
		#define STR0055 "Commission"
	#else
		...
		#define STR0025 If( cPaisLoc $ "ANG|PTG", "Relatório de Comissoes de Motoristas", "Relatorio de Comissöes de Motoristas" )
		...
		#define STR0046 "Por Motorista+Prefixo+Titulo+Parcela"
		#define STR0047 "Por Motorista+Cliente+Loja+Prefixo+Titulo+Parcela"
