...
User Function ETQ01()
    ...
    oPrinter:nVertSize := 140
	oPrinter:nHorzSize := 100
	...
	oSetup:SetPropert(PD_MARGIN      , {001,001,001,001})
...
static Function IMP_PAGINA()
	...
	oPrinter:Box( 0, 0, 307, 411.96, "-4")
	oPrinter:SayBitmap(5, 15, cArqLogo, 130, 60)
    nLin += 12
