...
@since 11/08/2022
/*/
Class PrintOrcamento From LongNameClass
...
/*/{Protheus.doc} PrintOrcamento::New
...
@param cTipo, character, ORC - Orcamento
                         PED - Pedido de Venda
/*/
Method New(cTipo) Class PrintOrcamento
...
/*/{Protheus.doc} PrintOrcamento::Close
...
@since 11/08/2022
/*/
Method Close() Class PrintOrcamento
...
/*/{Protheus.doc} PrintOrcamento::LeDados
...
/*/
Method LeDados(cFil, cNumero) Class PrintOrcamento
...
/*/{Protheus.doc} PrintOrcamento::PrintIni
...
/*/
Method PrintIni(cFil, cNumero) Class PrintOrcamento
...
/*/{Protheus.doc} PrintOrcamento::Imprime
...
@since 12/22/2022
/*/
Method Imprime() Class PrintOrcamento
...
/*/{Protheus.doc} PrintOrcamento::Imprime_Cab
Imprime o cabecalho
@type method
@version 1.00
@author Luiz Alves Felizardo
...
/*/
Method Imprime_Cab(lImpItens) Class PrintOrcamento
...
/*/{Protheus.doc} PrintOrcamento::Imprime_Rod
Imprime o rodape
@type method
@version 1.00
@author Luiz Alves Felizardo
@since 12/22/2022
/*/
Method Imprime_Rod() Class PrintOrcamento
...
/*/{Protheus.doc} PrintOrcamento::PrintFim
...
@since 12/22/2022
/*/
Method PrintFim() Class PrintOrcamento
...
*********************************************
Method LeOrc(cFil, cNumero) Class PrintOrcamento
*********************************************
...
*********************************************
Method LePed(cFil, cNumero) Class PrintOrcamento
*********************************************
...
Method CondComerc(cCondComerc) Class PrintOrcamento
